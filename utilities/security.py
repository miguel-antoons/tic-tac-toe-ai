...
program_files_path = "program_files/"


def create_key(files_path="program_files"):
    """
    ...
    with open(files_path + "/key.key", "wb") as key_file:
        key_file.write(key)
...
def load_key():
    ...
    """
    return open(program_files_path + "key.key", "rb").read()
